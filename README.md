# BingX Order Scheduler - Backend (GCP VM Deployable)

Standalone Node.js + TypeScript High-Precision Backend Engine for BingX Order Scheduling.
...
1. **Create a GCP VM Instance:**
   ...
   - **Region:** Choose `asia-northeast1 (Tokyo)` or `asia-southeast1 (Singapore)` for lowest ping latency to BingX servers.
...
2. **Allow Port 3001 in GCP Firewall:**
   ...
   - Name: `allow-bingx-scheduler-port-3001`
...
3. **Deploy Code on VM via SSH:**
   ...
   git clone https://github.com/YOUR_USERNAME/bingx-scheduler-backend.git
   cd bingx-scheduler-backend
